saveGraphComputeTermCountFunction <- function(maxGraph=1000,step=1)
{
...
test_that("Testing \'saveGraphComputeTermCount\'", {
  saveGraphComputeTermCountFunction()
  cat("\n End of test saveGraphComputeTermCount", "\n")
  cat("=====================")
})
