saveGraphComputeLagCountFunction <- function()
{
  maxGraph=1000
  step=100
...
test_that("Testing \'saveGraphComputeLagCount\'", {
  saveGraphComputeLagCountFunction
  cat("\n End of test saveGraphComputeLagCount", "\n")
  cat("=====================")
})
