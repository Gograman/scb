isInputCompatibleFunction <- function(maxGraph = 100,step = 10)
{
  cat("\n Testing \'tests_23_isInputCompatible\' \n")
...
test_that("Testing \'isInputCompatibleFunction\'", {
  isInputCompatibleFunction()
  cat("\n End of test isInputCompatibleFunction", "\n")
  cat("=====================")
})
